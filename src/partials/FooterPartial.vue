<template>
  <footer class="footer mt-6">
    <section class="footer__items bg-white border-t py-6">
      <div class="container mx-auto grid-container">
        <div class="footer__brand mb-3">
          ...
          <!-- Es importante colocar los link del router, de lo contrario, si se escribe la url
          directamente en la barra de navegación, se realiza una nueva peticion al servidor.
          por tanto, aunque se encuetre autenticado, se desconocerá por unos instantes.
          Y eso ocasiona que se le redireccione a otra pagina y no pueda entrar. -->
          <p>
            <router-link :to="{ name: 'HousesPages' }">Mis Casas</router-link>
          </p>
          <p>
            <router-link :to="{ name: 'ProfilePage' }">Mi Perfíl de usuario</router-link>
          </p>
        </div>
    ...
    <section class="footer__copyright bg-teal-dark py-4 text-white">
      <div class="container mx-auto">A Vue application for the course Advanced Vue by Bedu on Platzi</div>
    </section>
  </footer>
</template>
